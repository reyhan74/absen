          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <!--<li class="nav-item">
                  <a class="nav-link" href="../data_lokasi_presensi/lokasi_presensi.php" >
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link" href="../rekap/home.php" >
